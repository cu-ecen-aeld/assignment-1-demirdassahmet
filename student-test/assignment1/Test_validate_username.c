...
void test_validate_my_username()
{
    ...
    const char *in_config_file_user_name = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(hard_coded_user_name, in_config_file_user_name, "Incorrect user name!");
}
